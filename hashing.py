...
from xmlhelpers import add_missing_namespace

ENV_NS = 'xmlns:env="http://www.w3.org/2003/05/soap-envelope"'
...
def generate_hash(payload):
    xmldoc = etree.fromstring(add_missing_namespace(payload, ENV_NS))
